...
//		System.out.println("id : " + id + "/ pw :" + password);
		...
		// 3. 메모리에 저장된 아이디와 비밀번호를 확인
		// 3-2. 만약 하나라도 틀리다면 ' 로그인 정보가 일치하지 않습니다. ' 출력 후 프로그램 종류
		if (!id.equals(id) || !password.equals(password)) {
			System.out.println("로그인이 정보가 일치하지 않습니다.");
			return;
		}
