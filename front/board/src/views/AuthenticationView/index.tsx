//? Box 컴포넌트 : mui에서 공간을 할당하는 태그를 포함
//? Grid 컴포넌트 : mui에서 공간을 12등분하여 가로 사이즈에 따라 반응형 웹 개발을 지원
//? Typography 컴포넌트 : mui 에서 글자를 출력하는 모든 태그를 포함
...
//? 논리 연산자(&&) : if문만 쓸 때
//? 삼항 연산자 (조건 ? 참 : 거짓) : if - else / if -else if - else 쓸때
      ...
      <Grid container spacing={2}>
        ...
        <Grid item lg={5} sm={12}>
          <Card sx={{height : '630px', mt: '100px', mb:'80px', pt:'50px', pb:'30px', pl:'50px', pr:'50px'}}>
            ...
            {loginView ? (<LoginCardView setLoginView5={setLoginView} />) : (<SignUpCardView setLoginView={setLoginView} />)}
