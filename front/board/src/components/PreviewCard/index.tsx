...
import { Card, Box, Avatar, Typography, CardActionArea } from '@mui/material'
...
export default function PreviewCard({previewItem} : Props) {
  ...
  return (
    <Card  >
        <CardActionArea sx={{ height : '508px' , backgroundImage: backgroundImage, backgroundSize: 'cover'}} onClick={() => navigator(`previewItem.boardNumber}`)}>
