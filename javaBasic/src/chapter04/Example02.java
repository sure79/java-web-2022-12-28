...
public class Example02 {
	...
	public static void main(String[] args) {
		...
		String indentityNumber = "930602-1111111";
		String year = indentityNumber.substring(0,2);
		String month = indentityNumber.substring(2,4);
		String day = indentityNumber.substring(4,6);
		String gender = indentityNumber.substring(7,8);
		
		System.out.println("year : " + year + " month : " + month + " day : " + day + " gender : " + gender);

		// 문자열에 길이를 가져오는 String API method
		...
		//문자열에 앞뒤 공백을 제거하는 String API method
