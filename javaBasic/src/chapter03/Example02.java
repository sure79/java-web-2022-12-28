...
// 1. 접근 제어자
//  -public, protect, default(packge), private
// 2. 일반 제어자
...
public abstract class Example02 {
	...
	// protected  접근제어자
	// 같은 패키지내에 있거나 외부에 해당 클래스를 상속 받은 sub 클래스에서만 접근이 가능
	...
	// 반드시 class 에 abstract 제어자가 존재해야 함.
	...
	// final과 private은 동시에 사용할 필요가 없다. 

	public static void main(String[] args) {
		// Modifier 클래스의 경우 public 으로 선언되었기 때문에 
		// 모든 위치에서 사용 가능
		Modifier modifier = new Modifier("Jone", "Busan", "010");
		modifier.setName("jame");
		modifier.getName();
