...
import {Avatar, Box, Divider, IconButton, Menu, MenuItem, Paper, Typography, Card} from '@mui/material';
    ...
    <Box sx={{p: ' 100px 222px'}}>
        <Box>
            ...
            <Box sx={{ display: 'flex', mt:'20px'}}>
                ...
                <Box sx={{display:'flex'}}>
                    <MessageOutlinedIcon  sx={{ height: '24px', width:'24px', mr:'6px', opacity:0.7}}/>
